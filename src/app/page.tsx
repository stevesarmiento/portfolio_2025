...
export default function Home() {
  ...
  return (
    <main className="flex h-screen w-full overflow-hidden">
      {/* Content Column */}
      <div className="w-full lg:w-1/3 flex flex-col items-center text-[#2E4D61] bg-zinc-950 overflow-y-auto">
        <div className="flex flex-col gap-y-2 items-center justify-between py-24 border-l border-r border-dashed border-[#2E4D61]/30">
          <motion.div 
      ...
      <div className="hidden lg:flex lg:w-2/3 relative bg-zinc-950">
